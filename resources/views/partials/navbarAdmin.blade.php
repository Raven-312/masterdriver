<nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
    <div class="container"><a class="navbar-brand" href="/"><i class="fa fa-taxi"></i>&nbsp;Servicio de Transporte
       "Cochabamba"</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive"
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto text-uppercase">
               ...
               <!-- <li class="nav-item" style="margin-top: 10px;"><a class="btn btn-primary" role="button"
                        style="background: rgba(10,9,8,0.27);" href="/booking">Reserva un Viaje</a></li> -->
                <li class="nav-item" style="margin-top: 10px;"><a class="btn btn-primary btn-book" role="button"
                        href="/register">Conduce con nosotros</a></li>
